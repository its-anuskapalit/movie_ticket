...
{
	char pass[10],passW[10]="password";
	printf("Please enter the Password to change price of ticket: ");
	scanf("%s",&pass);
...
void ticket1(int choice,char name[10],int id2,int price)
{
        ...
        printf("\t============================================================\n");
        printf("\t Booking ID : %d \t\t\tShow Name : Dilwale Dulhania Le Jayenge\n",id2);
        printf("\t Customer  : %s\n",name);
...
int movie(void)
{
	...
	printf("\t\t\t----------------------------\n\n");
	printf("\t\t\tpress 1 Dilwale Dulhania Le Jayenge\n\n");
...
int cmovie(void)
{
	...
	printf("\t\t\t-------------------------------------\n");
	printf("\t\t\tpress 1 for Dilwale Dulhania Le Jayenge\n\n");
	printf("\t\t\tpress 2 for Avatar: The Way of Water\n\n");
	printf("\t\t\tpress 3 for Spider-Man: Far From Home\n\n");
	scanf("%d",&i);
	return i;
